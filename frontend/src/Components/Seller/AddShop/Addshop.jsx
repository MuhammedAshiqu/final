...
<Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>  <div className="addprod-form">
                    <input type="text" onChange={handleChange} name='name' placeholder='Shop name' /><br /><br />
                    <input type="text" onChange={handleChange} name='category' placeholder='Shop Category' /><br /><br />
